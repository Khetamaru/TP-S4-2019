...
import TeacherPlanning from './components/teachers/TeacherPlanning.vue'
...
const routes = [
    ...
    { path: '/students/class/:id?', component: StudentClass, beforeEnter: requireAuth },
    ...
    { path: '/teachers/planning/:id', component: TeacherPlanning, beforeEnter: requireAuth },
